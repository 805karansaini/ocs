...
query5 = """CREATE TABLE IF NOT EXISTS `combination_table` (
            ...
            `max_profit` DECIMAL(20, 10),
            `max_loss` DECIMAL(20, 10),
            `vega` DECIMAL(20, 10),
            `theta` DECIMAL(20, 10),
            `gamma` DECIMAL(20, 10),
            `vanna` DECIMAL(20, 10),
            ...
            `zomma` DECIMAL(20, 10),
            `color` DECIMAL(20, 10),
            `ultima` DECIMAL(20, 10),
            `correlation_delta` DECIMAL(20, 10),
            `cross_gamma` DECIMAL(20, 10),
            `cross_vanna` DECIMAL(20, 10),
            `cross_volga` DECIMAL(20, 10),
            FOREIGN KEY (`config_id`) REFERENCES `config_table`(`config_id`) ON DELETE CASCADE
    );"""
