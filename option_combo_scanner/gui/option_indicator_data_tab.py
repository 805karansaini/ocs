...
option_indicator_table_columns_width = [
    ("Indicator ID", 75, "Indicator ID"),
    ("Symbol", 75, "Symbol"),
    ("Sec Type", 75, "Sec Type"),
    ("Expiry", 75, "Expiry"),
    ("H.V", 75, "H.V"),
    ("I.V", 75, "I.V"),
    ("H.V. - I.V.", 75, "H.V. - I.V."),
    ("Risk Reversal 25", 75, "Risk Reversal 25"),
    ("Risk Reversal 50", 75, "Risk Reversal 50"),
    ("Risk Reversal 25-50", 75, "Risk Reversal 25-50"),
    ("Risk Chg Last Close", 75, "Risk Chg Last Close"),
    ("Max Pain", 75, "Max Pain"),
    ("Min Pain", 75, "Min Pain"),
    ("Avg I.V.", 75, "Avg I.V."),
    ("Avg H.V.", 75, "Avg H.V."),
    ("Open Interest Support", 75, "Open Interest Support"),
    ("Open Interest Resistance", 75, "Open Interest Resistance"),
    ("Put Volume", 75, "Put Volume"),
    ("Call Volume", 75, "Call Volume"),
    ("Put Call Volume Ratio", 75, "Put Call Volume Ratio"),
    ("Put Call Volume Average", 75, "Put Call Volume Average"),
    ("Change Underlying Option Price", 75, "Change Underlying Option Price"),
    ("Change Underlying Option Price 14 days", 75, "Change Underlying Option Price 14 days"),
    ("PC Change", 75, "PC Change"),
    ("I.V. Change", 75, "I.V. Change"),
    ("PC Change/I.V. Change", 75, "PC Change/I.V. Change"),
]
...
class OptionIndicator:
    ...
    def create_option_indicator_tab(self):
        ...
        option_indicator_table_frame.place(y=342, width=1484)
        ...
        for col_name, col_width, col_heading in option_indicator_table_columns_width:
            self.option_indicator_table.column(col_name, anchor="center", width=col_width)
    ...
    def add_indicator_values(
        ...
        values_dict = {
            ...
            'rr_50': "2333",
            'rr_25_50': "2333",
            'rr_change_last_close' : "2333",
            'max_pain': "2333",
            'min_pain': "2333",
            'avg_iv': "2333",
            'avg_hv' : "2333",
            'open_interest_support' : "2333",
            'open_interest_resistance' : "2333",
            'put_volume' : "2333",
            'call_volume' : "2333",
            'put_call_volume_ratio': "2333",
            'put_call_volume_average' : "2333",
            'change_underlying_option_price' : "2333",
            'change_underlying_option_price_14_days' : "2333",
            'pc_change' : "2333",
            'iv_change' : "2333",
            'pc_change_iv_change': "2333"
        }
        ...
        # if not inserted
        if not res:
            print(f"Insertion Failed in Indicator table: {values_dict}")
            return

        values_dict['indicator_id'] = indicator_id
        indicator_obj = Indicator(values_dict)

        # Insert rows in GUI of the Indicator Table
        self.insert_into_indicator_table(indicator_obj)
    
    def insert_into_indicator_table(self, indicator_obj):

        # Add indicator details to the indicator tree
        row_values = indicator_obj.get_indicator_tuple_for_gui()
