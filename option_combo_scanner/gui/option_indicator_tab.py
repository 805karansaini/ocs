...
option_indicator_table_columns_width = [
    ("Indicator ID", 165, "Indicator ID"),
    ("Instrument ID", 165, "Instrument ID"),
    ("Symbol", 165, "Symbol"),
    ("Sec Type", 165, "Sec Type"),
    ("Expiry", 165, "Expiry"),
    ("H.V", 165, "H.V"),
    ("iv_d1", 165, "I.V(D1)"),
    ("iv_d2", 165, "I.V(D2)"),
    ...
    ("rr_d1", 165, "RR(D1)"),
    ("rr_d2", 165, "RR(D2)"),
    ("change_rr_d1_14D", 165, "RR(D1)-Chg(14D)"),
    ("change_rr_d2_14D", 165, "RR(D2)-Chg(14D)"),
    ("change_rr_d1_1D", 165, "RR(D1)-Chg(1D)"),
    ("change_rr_d2_1D", 165, "RR(D2)-Chg(1D)"),
    ("avg_iv_avg_14d", 165, "Avg(IV)-Avg(14D)"),
    ("hv_14d_avg_14d", 165, "HV(14D)-Avg(14D)"),
    ("open_interest_support", 165, "OIS"),
    ("open_interest_resistance", 165, "OIR"),
    ("hv_14d_avg_iv", 165, "H.V. - I.V."),
    ("put_call_ratio_current", 165, "PC Volume Ratio"),
    ("put_call_ratio_avg", 165, "PC Volume Avg"),
    # ("pc_change", 165, "PC Change"),
    ("pc_change_iv_change", 165, "PC Change/I.V. Change"),
    ("Change Underlying Option Price", 165, "Chg Underlying OPT Price"),
    ("Change Underlying Option Price 14 days", 165, "Chg Underlying OPT Price 14 days"),
...
#
    ...
    def add_indicator_values(
        ...
        if existing_instrument:
            ...
            return
        values_dict = {
            "symbol": self.indicator_obj.symbol,
            "sec_type": self.indicator_obj.sec_type,
            "expiry": self.indicator_obj.expiry,
            "hv": "2333",
            "iv": "2333",
            "hv_iv": "2333",
            "rr_25": "2333",
    ...
    #     row_values = (
    #         indicator_obj.indicator_id,
    #         indicator_obj.symbol,
    #         indicator_obj.sec_type,
    #         indicator_obj.expiry,
