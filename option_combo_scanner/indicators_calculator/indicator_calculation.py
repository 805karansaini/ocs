...
class IndicatorCalculation:
    ...
    def calculate_realtime_market_data_based_indicators(flag_realtime_indicators):
        ...
        secondary_min_heap_indicator: MinHeap = copy.deepcopy(
            StrategyVariables.primary_min_heap_indicators
        )
        ...
        while secondary_min_heap_indicator:
            ...
            indicator_object = copy.deepcopy(
            ...
            underlying_contract, all_strikes = (
                IndicatorHelper.get_underlying_contract_and_all_strikes(
                    indicator_object,
                    symbol,
                    expiry,
                    sec_type,
            ...
            try:
                if flag_realtime_indicators:
                    ...
                    if (
                        StrategyVariables.flag_put_call_indicator_based_on_selected_deltas_only
                        == True
                        and (list_of_call_strike is None or list_of_put_strikes is None)
                    ):
                        # print(
                    ...
                    if Utils.flag_check_early_termination_of_indicator(
                        ...
                        if StrategyVariables.flag_test_print:
                            print(
                                f"Computing Put Call Volume based on (deltad1, deltad2, strikes) only"
                            )
                            print(
                                f"List Of List of Call {list_of_call_strike} and Put {list_of_put_strikes}"
                            )
    ...
    def compute_indicators():
        ...
        IndicatorCalculation.calculate_realtime_market_data_based_indicators(
            flag_realtime_indicators=flag_realtime_indicators
        )
