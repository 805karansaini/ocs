...
class variables(object):
    ...
    cas_map_con_id_to_action_type_and_combo_type = {}  # conid : {'BUY': { '1H': 0, '1D': 0} , 'SELL': { '1H': 0, '1D': 0}}

    # Setting it inside CAS SCREEN module(after condition is satisfied), updating values when combo deleted
    cas_conditional_legs_map_con_id_to_action_type_and_combo_type = {}  # conid : {'BUY': { '1H': 0, '1D': 0} , 'SELL': { '1H': 0, '1D': 0}}
    ...
    map_order_id_to_ib_algo_order = {}  # It will be used inside error callback and the IB Algo Order sending
